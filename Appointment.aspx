<%@ Page Title="" Language="VB" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="false" CodeFile="Appointment.aspx.vb" Inherits="User_Default" %>
...
<div class="container-fluid bg-primary py-5 hero-header mb-5">
    ...
    <asp:View ID="View1" runat="server">
        ...
        <table class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="width:100%;">
            <tr>
                ...
                <td class="style7">
                    <asp:Label ID="Label1" runat="server" 
                        style="font-size: x-large; font-family: Andalus" Text="Label"></asp:Label>
                </td>
                <td class="style8">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="style54">
                    &nbsp;</td>
                <td class="style55">
                    <asp:Button ID="Button1" runat="server" ForeColor="Blue" Text="Send Request" 
                        ValidationGroup="a" Height="42px" 
                        style="font-family: Andalus; font-size: large" Width="167px" />
                </td>
                <td class="style16">
                    &nbsp;</td>
            </tr>
        ...
        <asp:View ID="View2" runat="server">
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            &nbsp;&nbsp; <span class="style67">Your 
            appointment has been booked successfully. </span>
            <br />
            <br />
            <span class="style52">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Your appointment number is </span>
            <asp:Label ID="Label3" runat="server" Text="Label" Font-Bold="True" 
                Font-Size="Large" Font-Underline="True" ForeColor="Blue"></asp:Label>
            <span class="style52">&nbsp;. We provide more information regarding appointment on 
